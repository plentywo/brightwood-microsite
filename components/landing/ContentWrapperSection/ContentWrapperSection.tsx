...
export const ContentWrapperSection = (): JSX.Element => {
  const featureCards = [
    ...
    },
    {
      ...
      description:
        "Our executive team helped built and led Veyo, a healthcare logistics platform that supported millions of patients across the country. Today, we bring that same level of reliability, coordination, and compassion into the home—with care that's built around people, not systems.",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-8">
          {featureCards.slice(0, 4).map((card, index) => (
            <Card
              ...
              className="bg-[#c8c6ba1a] border-none rounded-lg backdrop-blur-[20px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(20px)_brightness(100%)]"
            >
