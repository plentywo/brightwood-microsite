      ...
      <div className="container px-4 lg:px-16 2xl:px-0 mx-auto">
        <div className="grid grid-cols-12 items-start gap-8 md:gap-8">
          <div className="col-span-12 lg:col-span-6">
            {/* Left Column */}
            <div className="gap-4 flex-1 grow flex flex-col relative">
              <h2 className="relative self-stretch font-playfair font-bold text-[#c6a664] text-4xl lg:text-5xl tracking-[-0.96px] leading-normal">
                Let's Build a Care Experience Around You
              </h2>

              <p className="relative self-stretch font-montserrat font-normal text-[#f8f5f0] text-base lg:text-xl tracking-[0] leading-[30px] pr-8">
              ...
              <Card className="items-end self-stretch w-full flex-[0_0_auto] mb-[-1.00px] ml-[-1.00px] mr-[-1.00px] bg-[#c8c6ba1a] rounded-lg backdrop-blur-[20px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(20px)_brightness(100%)] border-0">
                <CardHeader className="flex flex-col items-start gap-8 p-6 relative self-stretch w-full flex-[0_0_auto] border-b [border-bottom-style:solid] border-[#f8f5f04c]">
                  ...
                  <div className="flex flex-col items-start gap-2 self-stretch w-full relative flex-[0_0_auto]">
                    <div className="flex flex-col items-center justify-center gap-2 p-4 self-stretch w-full bg-[#f8f5f0] rounded-lg relative flex-[0_0_auto]">
                      <div className="relative w-fit mt-[-1.00px] font-montserrat font-bold text-[#1b1b1b] text-base md:text-lg lg:text-2xl tracking-[0] leading-8 flex items-center">
                        <span className="text-[#1B1B1B]">{'\uD83D\uDCDE'}</span> 24/7 Care
                        Line: (623) 400-7528
                      </div>
                ...
                <CardFooter className="flex items-center justify-center gap-2.5 p-6 self-stretch w-full relative flex-[0_0_auto]">
          ...
          <div className="col-span-12 lg:col-span-6">
            ...
            <Card className="flex flex-col items-start justify-center gap-6 p-6 relative flex-1 grow bg-[#f8f5f01a] rounded-lg backdrop-blur-[20px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(20px)_brightness(100%)] border-0">
              <CardHeader className="p-0">
                <h2 className="relative self-stretch font-bold text-[#c6a664] text-3xl lg:text-5xl tracking-[-0.96px] leading-[normal] mb-6 font-playfair">
                  Call us at (623) 400-7528
                </h2>

                <p className="font-montserrat font-normal text-[#f8f5f0] text-lg lg:text-xl leading-[30px] relative self-stretch tracking-[0]">
